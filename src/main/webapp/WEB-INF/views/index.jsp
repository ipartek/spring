<p>${path}</p>
<p>
	Usuario: <b>${pageContext.request.userPrincipal.name}</b>
</p>
<hr>

<form:form method="post" action="uploadImagen"
	enctype="multipart/form-data">
			Selecciconar Imagen a Subir: <input type="file" name="imagen">
	<input type="submit" value="Subir">
	<p>
		<i>*formato permitido image/jpeg.</i>
	</p>
	<p>
		<i>*Tamaño maximo 1Mb</i>
	</p>
</form:form>
...
<sec:authorize
	access="hasRole('ROLE_USER') and not hasRole('ROLE_ADMIN')">
